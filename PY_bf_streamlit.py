...
with st.expander("Show Correlation Heatmaps: Original, Levels, and Dummy Variables"):
    ...
    #corr_original_vars
    with col_1:
        st.subheader('Correlation Between Original Variables')
...
with st.expander('Show Logit Model'):
    ...
    choices = st.multiselect('Select any [Combination of] Indipendent Variable/s:', ['fraud_bool', 'income', 'name_email_similarity', 'prev_address_months_count', 'current_address_months_count',
                                                                                     ...
                                                                                     'proposed_credit_limit', 'foreign_request', 'session_length_in_minutes', 'keep_alive_session',
